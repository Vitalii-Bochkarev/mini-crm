  ...
  const settingsCards = [
    {
      ...
      details: ["Токен и профиль хранятся только в памяти текущей вкладки", "После обновления страницы требуется повторный вход", "При выходе текущая сессия очищается"],
    },
    {
